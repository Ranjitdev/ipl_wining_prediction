...
def deprecate_func_name(
    ...
    old_name
        The function's deprecated name within data_ingesion.py.
...
def deprecate_obj_name(
    ...
    old_name
        The object's deprecated name within data_ingesion.py.

    new_name
        The object's new name within data_ingesion.py.
